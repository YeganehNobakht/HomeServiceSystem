...
<div class="m">
    <div class="m1">
        <center>
            <form:form cssClass="m-5 p-5 text-center" cssStyle="width: 1200px" modelAttribute="pcDto" action="/products/search" method="post">
                <form:input type="hidden" path="">
            <button type="button" class="btn btn-light btn-lg m-5" onclick="parent.location='order/showOrder'">Show Order</button>
            </form:form>
    ...
    <div class="m11">
        <div class="m2">
            <div class="m3">
                <div class="m5">
                    <button type="button" class="btn btn-secondary btn-lg btn-block" name="completedOrder" id="completedOrder" onClick="parent.location='completedOrder'">Completed Orders</button>
                </div>
                <div class="m6">
                    <button type="button" class="btn btn-secondary btn-lg btn-block" name="currentOrder" id="currentOrder" onClick="parent.location='currentOrder'">Current Orders</button>
                </div>
            </div>
            <div class="m4">
                m4
