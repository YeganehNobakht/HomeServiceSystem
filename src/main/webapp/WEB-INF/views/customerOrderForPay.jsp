...
<div class="m">
    ...
    <div class="m11">
        <div class="m2">
            ...
            <div class="m4">
                <h3 class="d-flex justify-content-center text-danger">${message}</h3>
                <form:form modelAttribute="order">
                    <table class="table table-striped table-secondary table-hover">
                        <tr>
                            ...
                            <tr>
                                <td>${order.id}</td>
                                <td>${order.serviceCategory.name}</td>
                                <td>${order.subCategory.name}</td>
                                <td>${order.workDate}</td>
                                <td>${order.orderStatus}</td>
                                <td><a name="Select" onclick="choose(${order.id})"><button type="button">Select</button></a></td>
                            </tr>
